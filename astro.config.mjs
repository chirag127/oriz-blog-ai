          ...
          runtimeCaching: [
            {
              ...
              options: { cacheName: 'latent-fonts', expiration: { maxEntries: 30 } },
            },
            {
              urlPattern: ({ request }) => request.destination === 'document',
              handler: 'NetworkFirst',
              options: {
                cacheName: 'latent-pages',
            ...
            },
            {
              ...
              handler: 'StaleWhileRevalidate',
              options: { cacheName: 'latent-static', expiration: { maxEntries: 200 } },
            },
          ],
        },
      }),
